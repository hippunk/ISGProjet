...
public class MoveAnticorpSystem : FSystem {
    ...
    private Family _hostileGO = FamilyManager.getFamily(new AllOfComponents(typeof(RandomTarget),typeof(Aglutine)));
    private Family _anticorpGO = FamilyManager.getFamily(new AllOfComponents(typeof(AnticorpBacterie)));
