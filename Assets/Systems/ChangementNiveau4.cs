...
public class ChangementNiveau4 : FSystem {
	...
	private Family _hostileGO = FamilyManager.getFamily(new AnyOfComponents(typeof(Bacterie),typeof(Toxine))); // NOTE : changer components pour traiter tous les enemis
