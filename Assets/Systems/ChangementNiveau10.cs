...
public class ChangementNiveau10 : FSystem {
	// Use this to update member variables when system pause. 
	// Advice: avoid to update your families inside this function.
	private Family _defenseGO = FamilyManager.getFamily(new AllOfComponents(typeof(Cellule)), new NoneOfComponents(typeof(Infecte))); // NOTE : changer components pour traiter tous les enemis
