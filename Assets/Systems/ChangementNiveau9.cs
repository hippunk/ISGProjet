...
public class ChangementNiveau9 : FSystem {
	...
	private Family _hostileGO = FamilyManager.getFamily(new AnyOfComponents(typeof(Virus), typeof(Infecte))); // NOTE : changer components pour traiter tous les enemis
