...
public class MoveVirus : FSystem
{
    ...
    private Family _hostileGO = FamilyManager.getFamily(new AllOfComponents(typeof(Virus), typeof(Move)));
    private Family _celluleGO = FamilyManager.getFamily(new  NoneOfComponents(typeof(Infecte)) , new AnyOfComponents(typeof(Bacterie), typeof (Cellule)));
    ...
    protected override void onProcess(int familiesUpdateCount)
    {
        foreach (GameObject go in _hostileGO)
        {
            ...
            foreach (GameObject goi in _celluleGO)
            {
